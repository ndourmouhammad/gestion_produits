...
return [
    ...
    */
    ...
    'extensions' => 'Le champ :attribute doit avoir une extension parmi les suivantes : :values.',
    ...
    |--------------------------------------------------------------------------
    |
    | Vous pouvez spécifier des messages de validation personnalisés pour les attributs en utilisant
    | la convention "attribute.rule" pour nommer les lignes. Cela permet de spécifier rapidement
    | une ligne de langue personnalisée pour une règle d'attribut donnée.
    |
    */
    ...
    | avec quelque chose de plus convivial comme "Adresse E-Mail" au lieu de "email". Cela nous aide
